...
/proc/get_sfx(sound)
	if(istext(sound))
		switch(sound)
			...
			if("male_outofammo")
				sound = pick('sound/voice/out of ammo/outofammo_Boy.ogg', 'sound/voice/out of ammo/outofammo_Boy2.ogg', 'sound/voice/out of ammo/outofammo_Boy3.ogg')
			if("male_warcry")
			...
			if("female_outofammo")
				sound = pick('sound/voice/out of ammo/outofammo_Girl.ogg', 'sound/voice/out of ammo/outofammo_Girl2.ogg', 'sound/voice/out of ammo/outofammo_Girl3.ogg')
			if("female_warcry")
